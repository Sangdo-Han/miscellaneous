...
def main(x_point,
    ...
    micro_delay = int(micro_delay * 100000)
    ...
    while loop_flag:
        ...
        if nowtime.hour==(target_time//100) and \
           nowtime.minute >= target_time%100 and \
           nowtime.second >= second_delay and \
           nowtime.microsecond >= micro_delay:    
            pyautogui.click(x_point,y_point)
            print(f"clicked at {nowtime}")
            loop_flag = False
        else:
            print(nowtime, end='\r')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-md', '--micro_delay', type=int, default=1)
